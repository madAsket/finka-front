...
export const useBalanceStore = defineStore({
    ...
    actions: {
        async loadExpenses(projectId) {
            this.expenses = await this.getExpensesWithFilters(projectId, this.expenseFilters);
        },
        updateExpenseFilters(filters){
            this.expenseFilters = filters;
        ...
        async getExpensesWithFilters(projectId, filters){
            return await BalanceService.getExpensesWithFilters(projectId, filters);
        },
