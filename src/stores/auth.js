...
export const useAuthStore = defineStore({
    ...
    actions: {
        ...
        async resetPassword(creds){
            return await AuthService.resetPassword(creds);
        },
        async resetPasswordCheckToken(token){
            return await AuthService.resetPasswordCheckToken(token);
        },
        async resetPasswordConfirm(token, creds){
            return await AuthService.resetPasswordConfirm(token, creds);
        },
