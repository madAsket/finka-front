      ...
      <div class="space-y-6 max-w-96">
        ...
        <div class="border-t pt-5">
          ...
          <div class="flex items-center gap-x-3 mt-5">
            ...
            <FileUpload accept="image/png,image/jpeg,image/jpg" :maxFileSize="307200" mode="basic" @select="onFileSelect" 
            invalidFileSizeMessage="Invalid file size, file size should be less than 300KB."
            customUpload auto severity="secondary" class="p-button-outlined" />
            <small class="text-xs italic max-w-36">Choose PNG,JPG image with maximum 300KB.</small>
          </div>
