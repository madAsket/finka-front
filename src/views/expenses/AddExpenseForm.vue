...
const submitForm = async (values, addMore)=>{
...
const reloadForm = async()=>{
    ...
    fromStorage.value = storages.value[0];
}
...
const submitWithAddMore = handleSubmit(async (values) => {
...
<template>
    <form @submit="onAddExpense">
        ...
        <div class="flex justify-end">
            ...
            :disabled="submiting" 
            variant="outlined"
            severity="primary" label="Save & Add more" @click="submitWithAddMore" class="ml-2" type="submit" autofocus />
        </div>
    </form> 
</template>